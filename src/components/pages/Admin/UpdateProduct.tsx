...
function UpdateProduct() {
    ...
    const updatedProductId = products.find((product: Product) => product.id === id)
    ...
    const {title, imageURL, price, quantity, description, categoryId} = productUpdated
    ...
    const handleCategoryChange = (e: React.ChangeEvent<HTMLSelectElement>) => {
        ...
        if (selectedCategory) {
			setProductUpdated({ ...productUpdated, categoryId: selectedCategory.id, category: {
	...
	return (
		...
		<div className='mt-4 flex flex-col justify-center items-center mx-auto'>
			<form onSubmit={handleSubmit} className='bg-gray-800 py-6 px-20 rounded-sm bg-opacity-100 text-opacity-100 flex flex-col'>
			<button
			...
			>
				...
				<h2 className='text-white text-center text-xl mb-2'>Update a product</h2>

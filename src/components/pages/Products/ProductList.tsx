...
function ProductList() {
	...
	return (
		<div>
			...
			<div className='relative flex justify-end xs:justify-center mt-5 mr-5 xs:mx-2'>
				...
				{filter.length > 0 ? 
				<button className='absolute top-2 right-3 font-semibold text-lg' onClick={() => setFilter('')}>x</button>
				: ''
			}
			</div>
